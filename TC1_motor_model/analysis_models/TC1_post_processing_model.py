...
class PostProcessingModel(Model):
    ...
    def define(self):
        ...
        Rdc_expanded = csdl.expand(Rdc, (num_nodes,1))
        ...
        B_delta_expanded = csdl.expand(B_delta, (num_nodes,1))
        
        K_e = (a*np.pi)**2 * sigma_c/6
        V_s = csdl.expand((np.pi*l_ef*(D1-D_i)**2)-36*l_ef*Acu, (num_nodes,1)); # volume of stator
        K_c = 0.822;
        ...
        l_ef_expanded = csdl.expand(l_ef, (num_nodes,1))
        D2_expanded = csdl.expand(D2, (num_nodes,1))
